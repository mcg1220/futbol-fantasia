"""
One-off: add Pep Chavarría (Chelsea left-back, signed from Rayo Vallecano
in August 2026) to the player pool.
...
under any spelling at all (a brand-new signing, not in the pool at draft
time). Adding him directly under the accented spelling avoids ever hitting
the same un-accented-canonical bug this player pool has repeatedly had.

    python3 add_pep_chavarria.py            # dry run
    python3 add_pep_chavarria.py --apply
"""
import argparse
import sqlite3
